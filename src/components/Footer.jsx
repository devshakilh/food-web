...
const Footer = () => {
  return (
    <footer className="bg-yellow-600 font-sans min-h-80 min-w-0 ">
      <div className="container  py-12 lg:px-24 ">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-1 sm:gap-y-10 lg:grid-cols-4">
          <div className="sm:col-span-2">
            <h1 className="max-w-lg text-xl font-semibold tracking-tight text-black xl:text-2xl dark:text-white">
            ...
            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              <input
                id="email"
                type="text"
                className="px-4 py-2 w-40 text-gray-700 bg-white border rounded-md dark:bg-gray-900  dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
                placeholder="Email Address"
              />

              <button className="lg:w-full w-40 px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-blackrounded-lg hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <hr className="my-6 border-gray-200 md:my-8  h-2 hidden lg:block" />

        <div className="sm:flex sm:items-center sm:justify-between hidden lg:block">
